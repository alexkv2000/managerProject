...
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 1. Анализ и проектирование функциональности Блока 1. Анализ интеграции, миграции из сторонних сервисов.', 4, 'Неделя', true, true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	2, '25.12.2023',	1538000.00,0,0,0,'Блок 1 - 1. Протокол сдачи-приемки ЦИТРБ 2. Акт сдачи-приёмки оказанных услуэ',
           'Этап 2. Адаптация функциональности Блока 1 на основании Техпроекта', 8,'Неделя',true, true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	2, '26.02.2024',	1566000.00,0,0,0,'Блок 1 - 1. Протокол сдачи-приемки ЦИТРБ 2. Акт сдачи-приёмки оказанных услуг',
           'Этап 3. Настройка Интеграции и миграция данных', 8,'Неделя',true, true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 4. Тестовая эксплуатация и исправление замечаний Блок 1',	6,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 5. Опытно-промышленная эксплуатация',	2,	'Неделя', false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	2, '23.11.2024',	300000.00,0,0,0,'Блок 1 - 1. Отчет по сопровождению 2. Акт сдачи-приёмки оказанных услу',
           'Этап 6. Промышленная эксплуатация',28, 'Неделя',	false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 1. Подготовка к адаптации и выполнение предварительных настроек продукта RKIT: Управление претензионно-исковой работой и актами госорганов» для создания прикладного решения Экосистема для юристов',	3,	'Неделя', true,true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 1. Анализ и проектирование функциональности Блока 2',	3,	'Неделя',	false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	2, '13.08.2024',	759000.00,0,0,0,'Блок 2 - 1. Протокол сдачи-приемки ЦИТРБ 2. Акт сдачи-приёмки оказанных услуг',
           'Этап 2. Адаптация функциональности Блока 2 на основании Техпроекта',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 3. Настройка Интеграции',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 4. Тестовая эксплуатация и исправление замечаний Блок 2',	10,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
...
values (
           ...
           'Этап 6. Промышленная эксплуатация',	24,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
...
values (
           ...
           'Этап 4. Тестовая эксплуатация и исправление замечаний Блок 3',	10,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
...
values (
           ...
           'Этап 1. Анализ и проектирование функциональности',	4,	'Неделя', false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Этап 2. Настройка Интеграции и миграция данных',	8,	'Неделя', true,true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	6, '17.06.2024',	100000.00,0,0,0,'Блок 2 - 1. Отчет по сопровождению 2. Акт сдачи-приёмки оказанных услу',
           'Этап 3. Промышленная эксплуатация',	28,	'Неделя', true,true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	3, '22.10.2024',	225000.00,0,0,0,'Блок 4 - Тех.поддержка',	'Этап 1. тех.поддержка', 90, 'Часов',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
...
values (
           ...
           'Этап 1. Анализ и проектирование функциональности Блока 1',	4,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	3, '20.05.2024',	2155000.00,0,0,0,'Блок - Акт ввода в промышленную эксплуатацию.',
           'Эпат ввода в пром.эксплуатацию',	44,	'Неделя', true,true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '24.03.2025',	1845000.00,0,0,0,'Блок 3 -  web разработка Процесс целеполагания',
           'Этап 2. Реализация Блока 1',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '26.05.2025',	786000.00,0,0,0,'Блок 3 -  web разработка Процесс целеполагания',
           'Этап 3 Тестовая эксплуатация и исправление замечаний по Блоку 1',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '28.07.2025',	135000.00,0,0,0,'Блок 3 - web разработка Процесс целеполагания',
           'Этап 4. Опытно-промышленная эксплуатация по Блоку1',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '26.05.2025',	150000.00,0,0,0,'Блок 4 - web разработка Учет результатов целей',
           'Этап 1. Анализ и проектирование функциональности Блока 2',	4,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '28.07.2025',	774000.00,0,0,0,'Блок 4 - web разработка Учет результатов целей',
           'Этап 2. Реализация Блока 2',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '29.09.2025',	738000.00,0,0,0,'Блок 4 - web разработка Учет результатов целей',
           'Этап 3 Тестовая эксплуатация и исправление замечаний по Блоку 2',	8,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '27.10.2025',	120000.00,0,0,0,'Блок 4 - web разработка  Учет результатов целей',
           'Этап 4. Опытно-промышленная эксплуатация по Блоку 2',	4,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	8, '30.03.2026',	2553000.00,0,0,0,'Блок 5 - web разработка Учет результатов целей тех.поддержка, интеграция…',
           'Этап 5. Доработка в рамках функциональных блоков проекта',	24,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	1, '01.11.2024',	247500.00,0,0,0,'Тех.поддержка ноябрь-январь 2025г',	'тех.поддержка квартал РКИТ',	12,	'Неделя',true,true);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           '01.01.2024',	1, '25.11.2024',	3241328.00,0,0,0,'Лицензия 2025г DV=(2534439,6 + 200000МЧД) + 20% для ИК, СВА/ДВА',	'требуется 3-х сторонее соглашение для скидки 30%',	48,	'Неделя',false,false);
insert into library.plan_pay_project
(plan_year, project_id, data_planing, opex, opex_nds, capex, capex_nds, comment, step_project, duration, "interval", completed, payment_on_time)
values (
           ...
           'Создан договор Ид договора 1847387 ,№ договора ""."" от 16.10.2024 ,статус - проект .Контрагент ИНН - 3812087917   РКИТ(Иркутск) Ид контрагента 628253 Предприятие ООО ЦИТРБ',	12,	'Неделя', false,false);
